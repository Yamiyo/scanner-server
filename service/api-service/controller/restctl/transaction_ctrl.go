//go:generate mockgen -destination=./../../mocks/mock_transaction_ctrl.go -source=transaction_ctrl.go TxnCtrl
package restctl
...
// @Success 200 {object} resp{data=bo.GetTransactionInfoResp}
